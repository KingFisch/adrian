...
(function( jQuery ){
  var $hero = jQuery('#m-1643362606775');
  var $module = jQuery('#m-1643362606775').children('.module');
...
(function( jQuery ){
  var $module = jQuery('#m-1643885724689').children('.module');
  $module.gfV3Product();
})( window.GemQuery || jQuery );
    
    
(function(jQuery) {
  var $module = jQuery('#m-1643885724689-0').children('.module');
  var effect = $module.attr('data-effect');
...
(function(jQuery) {
var $module = jQuery('#m-1643887229207').children('.module');
...
(function(jQuery) {
var $module = jQuery('#m-1643892278182').children('.module');
$module.gfV4ProductImageList({
  onImageClicked: function(imageUrl, imageZoomUrl) {}
});
...
(function(jQuery) {
    var $module = jQuery('#m-1643885724689-2').children('.module');
...
(function(jQuery) {
  var $module = jQuery('#m-1643887051678').children('.module');
...
(function( jQuery ){
  var $module = jQuery('#m-1643885724689-3').children('.module');
...
(function( jQuery ){
  try {
    var $module = jQuery('#m-1643888080692').children('.module');
...
(function( jQuery ){
  try {
    var $module = jQuery('#m-1643896342041').children('.module');
    var single = $module.attr('data-single');
    var openDefault = $module.attr('data-openDefault');
    var openTab = $module.attr('data-openTab');
    var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
...
(function( jQuery ){
  var $module = jQuery('#m-1643896500249').children('.module');
  $module.gfV3Product();
})( window.GemQuery || jQuery );
